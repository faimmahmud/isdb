  ...
  <div class="container hero-content">
    <div class="row">
      <div class="col-lg-8">
        ...
        <h1 class="hero-title mt-3 reveal" style="max-width:12ch;">Big images, rich details, premium feel</h1>
        <p class="hero-lead mt-3 reveal">Every package is shown as a full-width experience card with price, rating, features, and motion-rich presentation.</p>
        ...
        <article class="package-card reveal" data-item="<?= e($pkg['category'] ?? 'all') ?>" data-search="<?= e($pkg['title'] . ' ' . ($pkg['country'] ?? '') . ' ' . ($pkg['description'] ?? '')) ?>">
          ...
          <div class="package-content">
            ...
            <div class="mt-2 d-flex flex-wrap gap-2">
              <a class="btn btn-ticket px-4" href="<?= e(app_path('booking.php?package=' . urlencode($pkg['title']))) ?>">Book now</a>

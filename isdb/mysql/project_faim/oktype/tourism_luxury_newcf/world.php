...
<section class="hero-shell" style="min-height:76vh;">
  ...
  <div class="container hero-content">
    <div class="row">
      <div class="col-lg-8">
        <span class="hero-kicker reveal">World Explorer</span>
        ...
        <h1 class="hero-title mt-3 reveal" style="max-width:11ch;">Travel the world in one premium view</h1>
        <p class="hero-lead mt-3 reveal">A dedicated country page with full-screen image panels, live motion, and premium presentation for global travel marketing.</p>
      </div>
    </div>
  </div>
</section>

  ...
  <div class="container-fluid px-4 px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="topNav">
      <ul class="navbar-nav mx-auto gap-lg-2">
        ...
        <li class="nav-item"><a class="nav-link" href="<?= e(app_path('countries.php')) ?>">Countries</a></li>
      ...
      <div class="d-flex gap-2 align-items-center">
        ...
        <?php else: ?>
          ...
          <a class="btn nav-cta btn-sm rounded-pill px-3" href="<?= e(app_path('booking.php')) ?>">Buy Ticket</a>

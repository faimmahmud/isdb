      ...
      <div class="col-lg-7">
        ...
        <form id="heroSearch" class="search-panel mt-4 reveal">
          <div class="input-group flex-grow-1">
            ...
            <input id="searchInput" type="text" class="form-control" placeholder="Search flights, destinations, tickets...">
          </div>
          <a href="#packages" class="btn btn-gold px-4">Explore Tours</a>
          <a href="<?= e(app_path('booking.php')) ?>" class="btn btn-outline-dark px-4">Buy Ticket</a>
        </form>
        ...
        <div class="booking-shortcuts reveal">
          ...
          <a href="<?= e(app_path('countries.php')) ?>" class="shortcut-chip"><i class="bi bi-globe2"></i> Country Atlas</a>
        </div>
...
<section class="arc-section arc-top">
  <div class="container">
    ...
    <div id="featuredToursCarousel" class="carousel slide reveal" data-bs-ride="carousel">
      <div class="carousel-indicators">
        <?php foreach (array_slice($featuredTours, 0, 3) as $i => $tour): ?>
          <button type="button" data-bs-target="#featuredToursCarousel" data-bs-slide-to="<?= $i ?>" class="<?= $i === 0 ? 'active' : '' ?>" aria-current="<?= $i === 0 ? 'true' : 'false' ?>" aria-label="Slide <?= $i + 1 ?>"></button>
        <?php endforeach; ?>
      </div>
      <div class="carousel-inner">
        <?php foreach (array_slice($featuredTours, 0, 3) as $i => $tour): ?>
          <div class="carousel-item <?= $i === 0 ? 'active' : '' ?>">
            <article class="full-hero-card" data-search="<?= e($tour['title'] . ' ' . $tour['category']) ?>">
              ...
              <div class="content">
                ...
                <div>
                  <a href="<?= e(app_path('booking.php')) ?>" class="btn btn-ticket px-4 me-2">Buy Ticket</a>
    ...
    <div class="surface p-4 p-lg-5 rounded-5 reveal">
      <div class="row align-items-center gy-4">
        ...
        <div class="col-lg-5 text-lg-end">
          <a href="<?= e(app_path('booking.php')) ?>" class="btn btn-ticket px-4 me-2">Buy Ticket</a>
          <a href="<?= e(app_path('countries.php')) ?>" class="btn btn-outline-dark px-4">Explore the world</a>
        </div>
      </div>
    </div>
  </div>

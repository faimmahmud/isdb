  ...
  <div class="container-fluid px-4 px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="topNav">
      ...
      <div class="d-flex gap-2 align-items-center flex-wrap justify-content-lg-end">
        <a class="btn btn-gold btn-sm rounded-pill px-3 align-items-center nav-ticket" href="<?= e(app_path('booking.php')) ?>"><i class="bi bi-ticket-perforated me-2"></i>Buy Ticket</a>
        <?php if ($currentUser): ?>
          <div class="nav-user">

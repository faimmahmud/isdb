  ...
  <div class="container-fluid px-4 px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="topNav">
      <ul class="navbar-nav mx-auto gap-lg-2">
        ...
        <li class="nav-item"><a class="nav-link" href="<?= e(app_path('booking.php')) ?>">Booking</a></li>
      ...
      <div class="d-flex gap-2 align-items-center flex-wrap justify-content-lg-end">
        <a class="btn btn-gold btn-sm rounded-pill px-3 d-none d-lg-inline-flex align-items-center" href="<?= e(app_path('booking.php')) ?>"><i class="bi bi-ticket-perforated me-2"></i>Buy Ticket</a>
        <?php if ($currentUser): ?>
          <div class="nav-user">

  ...
  <div class="container hero-content">
    <div class="row align-items-center gy-4">
      <div class="col-lg-7">
        ...
        <h1 class="hero-title mt-3 reveal text-animate"><?= e($heroSlides[0]['title']) ?></h1>
        ...
        <div class="surface rounded-5 p-4 reveal">
          <div class="d-flex align-items-center justify-content-between mb-3">
            <div>
              ...
              <h2 class="h3 fw-bold mb-0 text-animate">One-image storytelling</h2>
            </div>
          ...
          <div class="full-hero-card">
            ...
            <div class="content">
              ...
              <div class="d-flex flex-wrap gap-2 feature-list mb-4">
                <span>Worldwide</span><span>Premium curation</span><span>Smooth interaction</span>
              </div>
              <div>
                <a href="<?= e(app_path('packages.php')) ?>" class="btn btn-gold px-4 me-2">Explore packages</a>
                <a href="<?= e(app_path('countries.php')) ?>" class="btn btn-outline-light px-4">World countries</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row align-items-end mb-4 gy-3">
      <div class="col-lg-8">
        ...
        <h2 class="section-title reveal text-animate">Tour packages with a full-screen premium feel</h2>
      ...
      <?php foreach (array_slice($featuredTours, 0, 3) as $tour): ?>
        <article class="full-hero-card reveal" data-search="<?= e($tour['title'] . ' ' . $tour['category']) ?>">
          ...
          <div class="content">
            ...
            <div>
              <a href="<?= e(app_path('booking.php?package=' . urlencode($tour['title']))) ?>" class="btn btn-gold px-4 me-2">Buy Ticket</a>
  ...
  <div class="container">
    <div class="stats-wrap reveal">
      <div class="stats-grid">
        <?php foreach ($stats as $stat): ?>
          <div class="stat-box">
            <div class="num"><?= e($stat['value']) ?></div>
            <div class="label"><?= e($stat['label']) ?></div>
          </div>
        <?php endforeach; ?>
      </div>
  ...
  <div class="container">
    <div class="row align-items-end mb-4 gy-3">
      <div class="col-lg-8">
        ...
        <h2 class="section-title reveal text-animate">Trusted by travelers who value premium experiences</h2>
      </div>
    </div>
    ...
    <div class="surface p-4 p-lg-5 reveal">
      <div class="row align-items-center gy-4">
        <div class="col-lg-7">
          ...
          <h2 class="section-title mb-3 text-animate">Built to feel like a luxury startup</h2>
        ...
        <div class="col-lg-5 text-lg-end">
          ...
          <a href="<?= e(app_path('countries.php')) ?>" class="btn btn-outline-dark px-4">Explore countries</a>
        </div>
      </div>
    </div>
  </div>

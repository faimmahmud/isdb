...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_validate($_POST['csrf_token'] ?? null)) {
        ...
        $category = trim((string)($_POST['category'] ?? 'city'));
        $details = array_values(array_filter(array_map('trim', preg_split('/\R/', trim((string)($_POST['details'] ?? ''))))));
...
<section class="arc-section mt-0">
  <div class="container">
    <div class="form-shell p-4 p-lg-5 reveal">
      ...
      <h1 class="section-title mb-3 text-animate">Add tour package</h1>

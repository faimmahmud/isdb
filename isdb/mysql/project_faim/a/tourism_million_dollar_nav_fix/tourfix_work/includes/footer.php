  ...
  <div class="container py-5">
    <div class="row gy-4">
      <div class="col-lg-5">
        ...
        <p class="text-white-50 mb-0"><?= e($site['tagline']) ?></p>
      </div>
      <div class="col-6 col-lg-2">
        ...
        <ul class="list-unstyled footer-links">
          ...
          <li><a href="<?= e(app_path('countries.php')) ?>">Countries</a></li>
        </ul>
      </div>
      <div class="col-6 col-lg-2">
      ...
      <div class="col-lg-3">
        <h6 class="text-uppercase text-white-50 letter-wide">Concierge</h6>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between gap-2 text-white-50 small">
      ...
      <span>Luxury silent-luxury tourism platform.</span>
    </div>
  </div>
</footer>

  ...
  <div class="container hero-content">
    <div class="row">
      <div class="col-lg-8">
        ...
        <h1 class="hero-title mt-3 reveal text-animate" style="max-width:12ch;">Curated places with cinematic presentation</h1>
  ...
  <div class="container">
    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
      <div>
        ...
        <h2 class="section-title reveal text-animate">Luxury destinations, one full view at a time</h2>
      </div>
      ...
      <?php foreach ($destinations as $dest): ?>
        <article class="destination-card reveal" data-item="<?= e($dest['color']) ?>" data-search="<?= e($dest['name'] . ' ' . $dest['country'] . ' ' . $dest['tag']) ?>">
          ...
          <div class="destination-content">
            ...
            <h4 class="display-6 text-animate"><?= e($dest['name']) ?></h4>
            <p class="mb-4"><?= e($dest['summary']) ?></p>
            <div class="d-flex flex-wrap gap-2">
              <span class="price-chip text-dark bg-white"><?= e($dest['country']) ?></span>
              <a class="btn btn-gold" href="<?= e(app_path('booking.php')) ?>">Buy Ticket</a>
            </div>
          </div>
        </article>
      <?php endforeach; ?>
